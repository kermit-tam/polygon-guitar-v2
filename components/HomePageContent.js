    ...
    getRecentTabs(10).then((tabs) => {
      ...
      const fresh = tabs.map((t) => {
        ...
        return {
          ...
          ...(Array.isArray(t.artistIds) && t.artistIds.length > 1 ? { artistIds: t.artistIds } : {}),
          ...(Array.isArray(t.artists) && t.artists.length > 1 ? { artists: t.artists } : {}),
          ...(Array.isArray(t.collaboratorIds) && t.collaboratorIds.length > 1 ? { collaboratorIds: t.collaboratorIds } : {}),
