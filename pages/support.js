...
/** 與 public/support/*.jpg 實際像素比例一致（換圖後可用 sips -g pixelWidth -g pixelHeight 檔名 更新） */
const SUPPORT_IMG_WIDTH = 500
const SUPPORT_IMG_HEIGHT = 625
  ...
  return (
    <figure className="overflow-hidden rounded-lg border border-white/10 bg-[#121212]">
      <Image
        src={ph.src}
        alt={ph.alt}
        width={SUPPORT_IMG_WIDTH}
        height={SUPPORT_IMG_HEIGHT}
  ...
  return (
    <Layout>
      ...
      <article className="max-w-2xl mx-auto px-6 pb-16 pt-6">
        ...
        <div className={`space-y-5 mb-10 ${PROSE}`}>
          <p>
